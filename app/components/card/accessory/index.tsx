...
import { dataAccessory } from '@/app/constants'
import Image from 'next/image'
import AosDiv from '../../_corecomponent/aosEffect'
const CardAccessory = () => {
  return (
    <div className='font-jacarta '>
    <div className='w-full h-px header-div flex justify-start items-center rounded-full  transition-colors '>
      <div className='z-20 header-div px-2 rounded-xl border'>
        <h1 className='text-4xl font-extrabold textColor p-2'>Aksesuar</h1>
      </div>
    </div>
