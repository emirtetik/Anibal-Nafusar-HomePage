...
import { dataWoman } from '@/app/constants'
import Image from 'next/image'
import AosDiv from '../../_corecomponent/aosEffect'
const CardWoman = () => {
  return (
    <div className='mt-14 font-jacarta '>
